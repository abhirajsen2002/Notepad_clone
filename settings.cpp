...
void Settings::writeSettings(QString last_file, QFont font, bool load_recent, bool word_wrap, bool status_bar)
{
    QSettings settings("Abhiraj Sen", "Notepad");
...
void Settings::readSettings(QString *last_file, QFont *font, bool *load_recent, bool *word_wrap, bool *status_bar)
{
    QSettings settings("Abhiraj Sen", "Notepad");
    settings.beginGroup("Font");
